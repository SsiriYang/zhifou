...
<head>
    ...
    <title>知否 - 与世界分享你的知识、经验和见解</title>
...
<body class="zhi  no-auth">
                        ...
                        <div class="group-inputs">
                            ...
                            <div class="Captcha input-wrapper" data-type="cn" data-za-module="Captcha">
                                ...
                                <div class="Captcha-imageConatiner">
                                    <img class="Captcha-image" alt="验证码" src="../images/res/captcha.gif">
                                </div>
                            </div>
                        </div>
    ...
    <script type="text/json" class="json-inline" data-name="ga_vars">{"user_created":0,"now":1467946521000,"abtest_mask":"------------------------------","user_attr":[0,0,0,"-","-"],"user_hash":0}</script>
    ...
    <script src="../scripts/page-index.d7b54ac7.js"></script>
        ...
        <div class="view verification">
            <form>
                ...
                <div class="submit-wrapper">
                    <button class="submit blue-button">进入牛客</button>
                </div>
            </form>
        </div>
    </script>
    ...
    <script type="text/template" class="unable-login-template">
        ...
        <div class="view sms-login">
            <form>
                ...
                <div class="submit-wrapper">
                    <button class="submit blue-button">登录牛客</button>
                </div>
            </form>
        </div>
    </script>
    ...
    <div id="particles">
        <canvas class="particles-js-canvas-el" width="1366" height="608" style="width: 100%; height: 100%;"></canvas>
    </div>
</body>
</html>