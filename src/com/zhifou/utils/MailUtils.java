	...
	public static void sendMail(String email, String subject, String emailMsg)
		...
		Authenticator auth = new Authenticator() {
			public PasswordAuthentication getPasswordAuthentication() {
				return new PasswordAuthentication("zhifouy","bdnaqojhxcrsbgfd");//发邮件的账号的验证klecpbsfucflcjda  bdnaqojhxcrsbgfd(yang)
			}
		};
//		  1069038430@qq.com
		...
		message.setFrom(new InternetAddress("zhifouy@qq.com")); // 设置发送者
